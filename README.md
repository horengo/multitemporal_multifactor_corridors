...
1. Maps of areas with loose sand surfaces (i.e. deserts). This was not generated by the same code as it requires a Mchine Learning multi-sensor approach that would have been too heavy for a single script.
   Consequently, the GEE code calls the resulting map from my GGE asset repository. The GEE code for the generation of this map has also been provided for reproducibility reasons but it is not required to
